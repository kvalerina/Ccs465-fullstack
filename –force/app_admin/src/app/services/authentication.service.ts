...
export class AuthenticationService {
  ...
  // NOTE: For this applicationw e have dedcided that we will name
  ...
  // NOTE: For this application we have decided that will name
  // the key for our token 'travlr-token'
  ...
  // Uncomment the two console.log message for additional debugging
  // information.
